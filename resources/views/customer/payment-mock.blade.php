    ...
    <div class="mx-auto max-w-md">
        <div class="card overflow-hidden">
            <div class="border-b border-gray-200 px-6 py-5 text-center">
                ...
                <h1 class="text-lg font-bold text-gray-900">{{ $payment->paymentMethod?->name }}</h1>
                <p class="mt-1 text-sm text-gray-500">Order {{ $payment->order->order_number }}</p>
            </div>

            <div class="px-6 py-6">
                <div class="mb-2 flex items-center justify-between text-sm">
                    <span class="text-gray-600">Total Bayar</span>
                    <span class="text-2xl font-bold text-gray-900">Rp {{ number_format($payment->amount, 0, ',', '.') }}</span>
                </div>
                <div class="flex items-center justify-between text-sm">
                    <span class="text-gray-600">Status</span>
                    <span class="badge bg-amber-100 text-amber-700">Menunggu Pembayaran</span>
                </div>
