...
@section('content')
    <div class="mb-5 flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="flex flex-wrap gap-2">
            <a href="{{ route('admin.reports.export', request()->query()) }}" class="btn btn-secondary">
                <svg xmlns="http://www.w3.org/2000/svg" class="mr-1.5 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4v12m0 0l-4-4m4 4l4-4M4 20h16"/></svg>
                Export CSV
            </a>
