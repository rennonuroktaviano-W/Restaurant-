...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.payment-methods.store') }}" class="card mx-auto max-w-2xl p-6">
        @csrf

        <h1 class="mb-5 text-xl font-bold text-gray-900">Tambah Metode Pembayaran</h1>
