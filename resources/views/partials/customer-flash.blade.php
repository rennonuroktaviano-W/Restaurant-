@if (session('success'))
    <div role="alert" class="toast toast-success mt-5 mb-0 mx-auto w-[min(100%-2.5rem,1280px)]">
...
@if (session('status'))
    <div role="alert" class="toast toast-info mt-5 mb-0 mx-auto w-[min(100%-2.5rem,1280px)]">
...
@if (session('error'))
    <div role="alert" class="toast toast-error mt-5 mb-0 mx-auto w-[min(100%-2.5rem,1280px)]">
